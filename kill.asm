...
free(void *ap)
{
 ...
 621:	a1 30 08 00 00       	mov    0x830,%eax
{
 ...
 669:	5b                   	pop    %ebx
  freep = p;
 66a:	89 15 30 08 00 00    	mov    %edx,0x830
}
 670:	5e                   	pop    %esi
 671:	5f                   	pop    %edi
 672:	5d                   	pop    %ebp
 ...
 6a7:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6aa:	89 15 30 08 00 00    	mov    %edx,0x830
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 15 30 08 00 00    	mov    0x830,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 70b:	39 05 30 08 00 00    	cmp    %eax,0x830
 ...
 72e:	e8 ed fe ff ff       	call   620 <free>
  return freep;
 733:	8b 15 30 08 00 00    	mov    0x830,%edx
 ...
 75c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 75f:	89 15 30 08 00 00    	mov    %edx,0x830
}
 ...
 76f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 770:	c7 05 30 08 00 00 34 	movl   $0x834,0x830
 777:	08 00 00 
    base.s.size = 0;
 77a:	b8 34 08 00 00       	mov    $0x834,%eax
    base.s.ptr = freep = prevp = &base;
 77f:	c7 05 34 08 00 00 34 	movl   $0x834,0x834
 786:	08 00 00 
    base.s.size = 0;
 789:	c7 05 38 08 00 00 00 	movl   $0x0,0x838
 790:	00 00 00 
    if(p->s.size >= nunits){
