...
free(void *ap)
{
 ...
 621:	a1 24 08 00 00       	mov    0x824,%eax
{
 ...
 669:	5b                   	pop    %ebx
  freep = p;
 66a:	89 15 24 08 00 00    	mov    %edx,0x824
}
 670:	5e                   	pop    %esi
 671:	5f                   	pop    %edi
 672:	5d                   	pop    %ebp
 ...
 6a7:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6aa:	89 15 24 08 00 00    	mov    %edx,0x824
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 15 24 08 00 00    	mov    0x824,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 70b:	39 05 24 08 00 00    	cmp    %eax,0x824
 ...
 72e:	e8 ed fe ff ff       	call   620 <free>
  return freep;
 733:	8b 15 24 08 00 00    	mov    0x824,%edx
 ...
 75c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 75f:	89 15 24 08 00 00    	mov    %edx,0x824
}
 ...
 76f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 770:	c7 05 24 08 00 00 28 	movl   $0x828,0x824
 777:	08 00 00 
    base.s.size = 0;
 77a:	b8 28 08 00 00       	mov    $0x828,%eax
    base.s.ptr = freep = prevp = &base;
 77f:	c7 05 28 08 00 00 28 	movl   $0x828,0x828
 786:	08 00 00 
    base.s.size = 0;
 789:	c7 05 2c 08 00 00 00 	movl   $0x0,0x82c
 790:	00 00 00 
    if(p->s.size >= nunits){
