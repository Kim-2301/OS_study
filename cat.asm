 ...
 6c1:	a1 00 0b 00 00       	mov    0xb00,%eax
{
 ...
 709:	5b                   	pop    %ebx
  freep = p;
 70a:	89 15 00 0b 00 00    	mov    %edx,0xb00
}
 710:	5e                   	pop    %esi
 711:	5f                   	pop    %edi
 712:	5d                   	pop    %ebp
 ...
 747:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 74a:	89 15 00 0b 00 00    	mov    %edx,0xb00
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 769:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 76c:	8b 15 00 0b 00 00    	mov    0xb00,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7ab:	39 05 00 0b 00 00    	cmp    %eax,0xb00
 ...
 7ce:	e8 ed fe ff ff       	call   6c0 <free>
  return freep;
 7d3:	8b 15 00 0b 00 00    	mov    0xb00,%edx
 ...
 7fc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7ff:	89 15 00 0b 00 00    	mov    %edx,0xb00
}
 ...
 80f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 810:	c7 05 00 0b 00 00 04 	movl   $0xb04,0xb00
 817:	0b 00 00 
    base.s.size = 0;
 81a:	b8 04 0b 00 00       	mov    $0xb04,%eax
    base.s.ptr = freep = prevp = &base;
 81f:	c7 05 04 0b 00 00 04 	movl   $0xb04,0xb04
 826:	0b 00 00 
    base.s.size = 0;
 829:	c7 05 08 0b 00 00 00 	movl   $0x0,0xb08
 830:	00 00 00 
    if(p->s.size >= nunits){
