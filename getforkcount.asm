...
_getforkcount:     file format elf32-i386
...
main(void)
{
  ...
  11:	e8 45 03 00 00       	call   35b <getforkcount>
  ...
  30:	75 05                	jne    37 <main+0x37>
        // 자식 프로세스에서는 exit만 수행
        exit();
  32:	e8 7c 02 00 00       	call   2b3 <exit>
    }
    wait();  // 자식 프로세스가 종료될 때까지 대기
  37:	e8 7f 02 00 00       	call   2bb <wait>

    count = getforkcount();
  3c:	e8 1a 03 00 00       	call   35b <getforkcount>
  ...
  4a:	e8 f1 03 00 00       	call   440 <printf>
    ...
    exit();
  4f:	e8 5f 02 00 00       	call   2b3 <exit>
  54:	66 90                	xchg   %ax,%ax
  56:	66 90                	xchg   %ax,%ax
  58:	66 90                	xchg   %ax,%ax
  5a:	66 90                	xchg   %ax,%ax
...
free(void *ap)
{
 ...
 621:	a1 50 08 00 00       	mov    0x850,%eax
{
 ...
 669:	5b                   	pop    %ebx
  freep = p;
 66a:	89 15 50 08 00 00    	mov    %edx,0x850
}
 670:	5e                   	pop    %esi
 671:	5f                   	pop    %edi
 672:	5d                   	pop    %ebp
 ...
 6a7:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6aa:	89 15 50 08 00 00    	mov    %edx,0x850
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 15 50 08 00 00    	mov    0x850,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 70b:	39 05 50 08 00 00    	cmp    %eax,0x850
 ...
 72e:	e8 ed fe ff ff       	call   620 <free>
  return freep;
 733:	8b 15 50 08 00 00    	mov    0x850,%edx
 ...
 75c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 75f:	89 15 50 08 00 00    	mov    %edx,0x850
}
 ...
 76f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 770:	c7 05 50 08 00 00 54 	movl   $0x854,0x850
 777:	08 00 00 
    base.s.size = 0;
 77a:	b8 54 08 00 00       	mov    $0x854,%eax
    base.s.ptr = freep = prevp = &base;
 77f:	c7 05 54 08 00 00 54 	movl   $0x854,0x854
 786:	08 00 00 
    base.s.size = 0;
 789:	c7 05 58 08 00 00 00 	movl   $0x0,0x858
 790:	00 00 00 
    if(p->s.size >= nunits){
